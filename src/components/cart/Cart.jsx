...
const Cart = () => {
  ...
  return (
    <div className="lg:px-14 sm:px-8 px-4 py-10">
      ...
      <div className="border-t-[1.5px] border-slate-200 py-4 flex sm:flex-row sm:px-0 px-2 flex-col sm:justify-end gap-4 ">
        <div className="flex text-sm gap-1 flex-col">
          ...
          <Link to="/checkout" className="w-full flex justify-end">
            <button
              className="font-semibold w-[300px] py-2 px-4 rounded-sm bg-custom-blue text-white 
              flex items-center justify-center gap-2 hover:text-gray-300 transition duration-300 cursor-pointer"
            >
