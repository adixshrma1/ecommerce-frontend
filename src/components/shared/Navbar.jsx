      ...
      <div className="lg:px-14 sm:px-8 px-4 w-full flex justify-between">
        ...
        <ul
          className={`flex sm:gap-10 gap-4 sm:items-center sm:static absolute left-0 top-[70px] sm:shadow-none shadow-md
            ...
            } transition-all duration-100 sm:h-fit sm:bg-none bg-custom-gradient text-white
        ...
        >
          ...
          <li className="font-[500] transition-all duration-150">
            <Link
              to="/login"
              className="flex items-center space-x-2 px-4 py-[6px] bg-gradient-to-r from-purple-600 to-red-500 text-white font-semibold rounded-md shadow-lg 
