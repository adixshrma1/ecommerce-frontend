  ...
  return (
    <>
      <Dialog open={isOpen} as="div" className="relative z-10" onClose={close}>
        <DialogBackdrop className="fixed inset-0 bg-gray-500 opacity-75 transition-opacity duration-150" />
          ...
          <div className="flex min-h-full items-center justify-center p-4">
            ...
            >
              ...
              <div className="px-6 py-4 flex justify-end gap-4">
                ...
                className="px-4 py-2 text-sm font-semibold text-slate-700 border border-slate-700
                 hover:text-slate-800 hover:border-slate-800 rounded-md cursor-pointer"
                >Close</button>
              </div>
            </DialogPanel>
          </div>
