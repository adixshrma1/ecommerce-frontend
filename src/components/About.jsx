import aboutUsImg from "../assets/about/aboutUs.jpg";
import ProductCard from "./shared/ProductCard";
import IphoneImg from "../assets/about/iphone17pro.jpg";
import SamsungS24 from "../assets/about/SamsungS24U.jpg";
import Pixel from "../assets/about/pixel9.jpg";
      ...
      <div className="flex flex-col lg:flex-row justify-between items-center mb-12">
        <div className="w-full md:w-1/2 text-center md:text-left">
          <p className="text-lg mb-4">
            Welcome to our E-shop store! We are dedicated to provide quality
            products and services to our customers. Our mission is seamless
            shopping experience while ensuring the highest quality of our
            offerings.
          </p>
        </div>
